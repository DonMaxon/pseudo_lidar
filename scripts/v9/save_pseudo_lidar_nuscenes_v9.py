"""
save_pseudo_lidar_nuscenes_v9.py

v9 = v7 + три исправления:
...
Запуск:
    python scripts/v9/save_pseudo_lidar_nuscenes_v9.py \\
        --dataroot /home/max/Phd/Phase1/Sparse4D/data/nuscenes \\
        --version v1.0-mini \\
        --output_dir ./output/pseudo_lidar_nuscenes_v9
"""
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="v9: fix sensor-frame filter + closest voxel + SOR3 + SegFormer-B5")
    p.add_argument("--dataroot", default="/home/max/Phd/Phase1/Sparse4D/data/nuscenes")
    p.add_argument("--version",  default="v1.0-mini")
    p.add_argument("--output_dir", default="./output/pseudo_lidar_nuscenes_v9")
