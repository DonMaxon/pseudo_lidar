...
Сравнение BEV реального LiDAR и pseudo-LiDAR v7 для всех сцен nuScenes mini.
...
Раскладка на картинке (3 ряда):
    ...
    Ряд 3: Real LiDAR BEV | Pseudo-LiDAR v7 BEV

Запуск:
    python scripts/visualize_bev_v7.py \\
        --dataroot /home/max/Phd/Phase1/Sparse4D/data/nuscenes \\
        --pseudo_dir ./output/pseudo_lidar_nuscenes \\
        --output_dir ./output/bev_vis_v7 \\
        --n_samples 10
"""
...
def main():
    ...
    ap.add_argument("--pseudo_dir", default="./output/pseudo_lidar_nuscenes")
    ap.add_argument("--output_dir", default="./output/bev_vis_v7")
    ...
    for idx, token in enumerate(tokens):
        ...
        draw_bev(ax_pseudo, pseudo_bev,
                 title="Pseudo-LiDAR v7  (DA3METRIC-LARGE)",
