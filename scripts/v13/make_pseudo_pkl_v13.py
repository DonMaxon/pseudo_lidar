"""
make_pseudo_pkl_v13.py

Запуск:
    python scripts/v13/make_pseudo_pkl_v13.py \\
        --v1_pkl  output/pseudo_lidar_nuscenes/bevdetv5-nuscenes_infos_val_pseudo.pkl \\
        --out_dir output/pseudo_lidar_nuscenes_v13
"""
...
def main():
    ...
    out_pkl = out_dir / "bevdetv5-nuscenes_infos_val_pseudo_v13.pkl"
    ...
    for info in data["infos"]:
        info["lidar_path"] = info["lidar_path"].replace(
            "nuscenes_pseudo/", "nuscenes_pseudo_v13/"
        )
