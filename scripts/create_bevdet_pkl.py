"""
create_bevdet_pkl.py

Создаёт PKL-файл в формате BEVDet из pseudo-LiDAR данных и nuScenes метаданных.
Аналог BEVDet/tools/create_data_bevdet.py, но для произвольного датасета и
произвольной папки с pseudo-LiDAR.

Запуск:
    conda activate bevdet
    python scripts/create_bevdet_pkl.py \
        --dataroot /home/max/Phd/Phase1/dataset/v1.0-trainval \
        --pseudo_lidar_dir /home/max/Phd/Phase1/dataset/pseudo_lidar_v16 \
        --version v1.0-trainval \
        --out /home/max/Phd/Phase1/dataset/pseudo_lidar_v16/bevdet_infos.pkl
"""
...
def main():
    ...
    p.add_argument('--pseudo_lidar_dir', required=True)
