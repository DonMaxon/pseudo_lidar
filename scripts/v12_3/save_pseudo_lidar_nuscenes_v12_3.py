"""
save_pseudo_lidar_nuscenes_v12_3.py

v12.3 = v12 с исправлением ошибки #3:
  Bug 3 (Z-диапазон RANSAC): z_max=-0.8 включает объекты на высоте ~1м от земли.
  Fix: z_min=-2.2, z_max=-1.5 — более узкий диапазон, строго соответствующий земле.
...
Запуск:
    python scripts/v12/save_pseudo_lidar_nuscenes_v12.py \\
        ...
        --version v1.0-mini \\
        --output_dir ./output/pseudo_lidar_nuscenes_v12_3
"""
...
def parse_args():
    p = argparse.ArgumentParser(description="v12.3: v12 + fix z-range RANSAC (z_min=-2.2, z_max=-1.5)")
    p.add_argument("--dataroot",   default="/home/max/Phd/Phase1/Sparse4D/data/nuscenes")
    p.add_argument("--version",    default="v1.0-mini")
    p.add_argument("--output_dir", default="./output/pseudo_lidar_nuscenes_v12_3")
