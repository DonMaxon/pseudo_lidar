"""
save_pseudo_lidar_nuscenes_v15.py

v15 = v12 + Grid Penetration Filter
...
Запуск:
    python scripts/v15/save_pseudo_lidar_nuscenes_v15.py \\
        --dataroot /home/max/Phd/Phase1/Sparse4D/data/nuscenes \\
        --version v1.0-mini \\
        --output_dir ./output/pseudo_lidar_nuscenes_v15
"""
...
def build_pseudo_lidar_global(cam_data_dict, estimator, back_proj, range_filter,
    ...
    for cam_name, cam in cam_data_dict.items():
        ...
        depth_map_filt = apply_sobel_edge_filter(depth_map_raw, sobel_threshold, sobel_dilation)
...
def parse_args():
    p = argparse.ArgumentParser(description="v15: v12 + Grid Penetration Filter")
    p.add_argument("--dataroot",   default="/home/max/Phd/Phase1/Sparse4D/data/nuscenes")
    p.add_argument("--version",    default="v1.0-mini")
    p.add_argument("--output_dir", default="./output/pseudo_lidar_nuscenes_v15")
